...
const BINARY_START_ADDR: usize = BOOTLOADER_START_ADDR + 0x80000;
...
fn jump_to(addr: *mut u8) -> ! {
    ...
    unsafe {
        kprintln!("Contents of jump: {:?}", *addr);
        asm!("br $0" : : "r"(addr as usize));
        loop { asm!("nop" :::: "volatile")  }
    }
}

pub fn progress_fn(progress: Progress) {
}
...
pub unsafe extern "C" fn kmain() {
    ...
    let mut buffer = core::slice::from_raw_parts_mut(BINARY_START, MAX_BINARY_SIZE);
